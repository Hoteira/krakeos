use crate::wasm::{
    ...
    execution::value::{ExternAddr, Ref, ValueTypeMismatchError, F32, F64}, RefType,
};
...
impl AbstractStored for StoredValue {
    ...
    unsafe fn from_bare(bare_value: Self::BareTy, id: crate::wasm::execution::store::StoreId) -> Self {
        match bare_value {
    ...
    fn id(&self) -> Option<crate::wasm::execution::store::StoreId> {
        match self {
