...
use crate::wasm::common::value::{ExternAddr, Ref, Value, ValueTypeMismatchError, F32, F64};
use crate::wasm::common::reader::types::RefType;
use crate::wasm::interpreter::store::StoreId;
...
impl TryFrom<StoredValue> for u32 {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "u32", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for i32 {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "i32", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for u64 {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "u64", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for i64 {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "i64", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for F32 {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "F32", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for F64 {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "F64", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for [u8; 16] {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "[u8; 16]", actual: value.into_bare() }),
        }
    }
}
...
impl TryFrom<StoredValue> for StoredRef {
    ...
    fn try_from(value: StoredValue) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err(ValueTypeMismatchError { expected: "Ref", actual: value.into_bare() }),
        }
    }
}
