...
impl<'a> AotCompiler<'a> {
    ...
    fn compile_function_body(&mut self, local_func_idx: usize) {
        ...
        reader.pc = span.from;
        let locals = crate::wasm::common::validation::code::read_declared_locals(&mut reader).unwrap();
        let total_locals = param_count + locals.len();

        // Locals area on stack
        self.emitter.sub_reg_imm32(Reg::RSP, (total_locals * 16) as u32);
        ...
        for i in 0..param_count {
            ...
            self.emitter.mov_reg_mem64(Reg::RAX, Reg::RBP, src_offset as i32);
            self.emitter.mov_reg_mem64(Reg::RDX, Reg::RBP, (src_offset + 8) as i32);
            self.emitter.mov_mem64_reg(Reg::R15, (i * 16) as i32, Reg::RAX);
            self.emitter.mov_mem64_reg(Reg::R15, (i * 16 + 8) as i32, Reg::RDX);
        }
        ...
        if !locals.is_empty() {
            ...
            for i in 0..locals.len() {
                ...
                self.emitter.mov_mem64_reg(Reg::R15, (idx * 16 + 8) as i32, Reg::RAX);
            }
        }
        ...
        if self.result_count > 0 {
            for i in 0..self.result_count {
                self.emitter.mov_reg_mem64(Reg::R10, Reg::R11, (i * 16) as i32);
                self.emitter.mov_mem64_reg(Reg::RAX, (i * 16) as i32, Reg::R10);
                self.emitter.mov_reg_mem64(Reg::R10, Reg::R11, (i * 16 + 8) as i32);
                self.emitter.mov_mem64_reg(Reg::RAX, (i * 16 + 8) as i32, Reg::R10);
            }
        }
    ...
    fn compile_instruction(&mut self, instr: Instruction, reader: &mut WasmReader) {
        match instr {
            ...
            Instruction::F32Const(val) => {
                self.emitter.mov_reg_imm64(Reg::RAX, (val.to_bits() as u32) as u64);
                self.emitter.push_wasm_stack(Reg::RAX);
                self.stack_depth += 1;
            }
            ...
            Instruction::I32Clz => {
                ...
                self.emitter.emit_u8(0x48); self.emitter.emit_u8(0x0F); self.emitter.emit_u8(0x45); self.emitter.emit_u8(0xC2);
                self.emitter.push_wasm_stack(Reg::RAX);
            }
            Instruction::I32Ctz => {
                self.emitter.pop_wasm_stack(Reg::RAX);
                ...
                self.emitter.mov_reg_imm64(Reg::RAX, 32);
                self.emitter.emit_u8(0x48); self.emitter.emit_u8(0x0F); self.emitter.emit_u8(0x45); self.emitter.emit_u8(0xC1);
                self.emitter.push_wasm_stack(Reg::RAX);
            }
            ...
            Instruction::F32Ceil => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundss_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 2);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            Instruction::F32Floor => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundss_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 1);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            Instruction::F32Trunc => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundss_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 3);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            Instruction::F32Nearest => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundss_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 0);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            ...
            Instruction::F64Ceil => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundsd_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 2);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            Instruction::F64Floor => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundsd_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 1);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            Instruction::F64Trunc => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundsd_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 3);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            Instruction::F64Nearest => {
                self.emitter.pop_v128(XmmReg::XMM0);
                self.emitter.roundsd_xmm_xmm_imm8(XmmReg::XMM0, XmmReg::XMM0, 0);
                self.emitter.push_v128(XmmReg::XMM0);
            }
            ...
            Instruction::F32ConvertI64U => {
                self.emit_trampoline_unop(crate::wasm::aot::trampoline::aot_f32_convert_i64_u as usize);
            }
            ...
            Instruction::F64ConvertI64U => {
                self.emit_trampoline_unop(crate::wasm::aot::trampoline::aot_f64_convert_i64_u as usize);
            }
            ...
            Instruction::I32TruncF32U => {
                self.emit_trampoline_unop_f32_to_i32(crate::wasm::aot::trampoline::aot_i32_trunc_f32_u as usize);
            }
            ...
            Instruction::I32TruncF64U => {
                self.emit_trampoline_unop_f64_to_i32(crate::wasm::aot::trampoline::aot_i32_trunc_f64_u as usize);
            }
            ...
            Instruction::I64TruncF32U => {
                self.emit_trampoline_unop_f32_to_i64(crate::wasm::aot::trampoline::aot_i64_trunc_f32_u as usize);
            }
            ...
            Instruction::I64TruncF64U => {
                self.emit_trampoline_unop_f64_to_i64(crate::wasm::aot::trampoline::aot_i64_trunc_f64_u as usize);
            }
            ...
            Instruction::Call(idx) => {
                ...
                if idx < self.validation_info.imports_length.imported_functions {
                    ...
                    self.emitter.sub_reg_imm32(Reg::RSP, 8); // Align
                    self.emitter.mov_reg_reg(Reg::RDX, Reg::RSP);
                    self.emitter.add_reg_imm32(Reg::RDX, (16 + reserve_space) as u32); // sp
                    self.emitter.mov_reg_imm64(Reg::RSI, idx as u64);
            ...
            Instruction::Block(bt) => {
                ...
                let result_count = match bt {
                    ...
                    BlockType::Type(idx) => self.validation_info.types[idx as usize].returns.valtypes.len(),
                };
                self.control_stack.push(ControlBlock {
    ...
    fn emit_unwind(&mut self, target_idx: usize) {
        let cb = &self.control_stack[target_idx];
        let result_count = if cb.kind == ControlBlockKind::Loop { 0 } else { cb.result_count };
        let drop_count = self.stack_depth.saturating_sub(cb.stack_depth_before + result_count);
        ...
        if result_count > 0 && drop_count > 0 {
            ...
            for i in (0..result_count).rev() {
                self.emitter.mov_reg_mem64(Reg::RAX, Reg::RSP, (i * 16) as i32);
                self.emitter.mov_reg_mem64(Reg::RDX, Reg::RSP, (i * 16 + 8) as i32);
                self.emitter.mov_mem64_reg(Reg::RSP, ((i + drop_count) * 16) as i32, Reg::RAX);
                self.emitter.mov_mem64_reg(Reg::RSP, ((i + drop_count) * 16 + 8) as i32, Reg::RDX);
            }
        }
    ...
    fn compile_simd(&mut self, sub: u32, reader: &mut WasmReader) {
        ...
        match sub {
            ...
            V128_LOAD8X8_S => self.emit_simd_load_extend(reader, crate::wasm::aot::trampoline::aot_v128_load8x8_s as usize),
            V128_LOAD8X8_U => self.emit_simd_load_extend(reader, crate::wasm::aot::trampoline::aot_v128_load8x8_u as usize),
            V128_LOAD16X4_S => self.emit_simd_load_extend(reader, crate::wasm::aot::trampoline::aot_v128_load16x4_s as usize),
            V128_LOAD16X4_U => self.emit_simd_load_extend(reader, crate::wasm::aot::trampoline::aot_v128_load16x4_u as usize),
            V128_LOAD32X2_S => self.emit_simd_load_extend(reader, crate::wasm::aot::trampoline::aot_v128_load32x2_s as usize),
            V128_LOAD32X2_U => self.emit_simd_load_extend(reader, crate::wasm::aot::trampoline::aot_v128_load32x2_u as usize),
            ...
            I8X16_SHUFFLE => {
                ...
                for i in 0..16 { lanes[i] = reader.read_u8().unwrap(); }
                self.emitter.sub_reg_imm32(Reg::RSP, 16);
                ...
                self.emitter.mov_mem64_reg(Reg::RSP, 8, Reg::RDX);
                self.stack_depth += 1;
                self.emit_simd_trampoline_ternary(crate::wasm::aot::trampoline::aot_v128_i8x16_shuffle as usize);
            ...
            V128_AND => { self.emitter.pop_v128(XmmReg::XMM1); self.emitter.pop_v128(XmmReg::XMM0); self.emitter.andps_xmm_xmm(XmmReg::XMM0, XmmReg::XMM1); self.emitter.push_v128(XmmReg::XMM0); self.stack_depth -= 1; }
            V128_OR  => { self.emitter.pop_v128(XmmReg::XMM1); self.emitter.pop_v128(XmmReg::XMM0); self.emitter.orps_xmm_xmm(XmmReg::XMM0, XmmReg::XMM1); self.emitter.push_v128(XmmReg::XMM0); self.stack_depth -= 1; }
            V128_XOR => { self.emitter.pop_v128(XmmReg::XMM1); self.emitter.pop_v128(XmmReg::XMM0); self.emitter.xorps_xmm_xmm(XmmReg::XMM0, XmmReg::XMM1); self.emitter.push_v128(XmmReg::XMM0); self.stack_depth -= 1; }
            V128_NOT => {
                self.emitter.pop_v128(XmmReg::XMM0);
            ...
            V128_ANDNOT => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_v128_andnot as usize),
            ...
            I8X16_ALL_TRUE => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_all_true_i8x16 as usize),
            I8X16_BITMASK => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_bitmask_i8x16 as usize),
            I16X8_ALL_TRUE => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_all_true_i16x8 as usize),
            I16X8_BITMASK => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_bitmask_i16x8 as usize),
            I32X4_ALL_TRUE => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_all_true_i32x4 as usize),
            I32X4_BITMASK => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_bitmask_i32x4 as usize),
            I64X2_ALL_TRUE => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_all_true_i64x2 as usize),
            I64X2_BITMASK => self.emit_simd_trampoline_reduction(crate::wasm::aot::trampoline::aot_v128_bitmask_i64x2 as usize),
            
            I8X16_NARROW_I16X8_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_narrow_i16x8_s as usize),
            I8X16_NARROW_I16X8_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_narrow_i16x8_u as usize),
            I16X8_NARROW_I32X4_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_narrow_i32x4_s as usize),
            I16X8_NARROW_I32X4_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_narrow_i32x4_u as usize),
            
            I16X8_EXTEND_LOW_I8X16_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_extend_low_i8x16_s as usize),
            I16X8_EXTEND_HIGH_I8X16_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_extend_high_i8x16_s as usize),
            I16X8_EXTEND_LOW_I8X16_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_extend_low_i8x16_u as usize),
            I16X8_EXTEND_HIGH_I8X16_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_extend_high_i8x16_u as usize),
            I32X4_EXTEND_LOW_I16X8_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_extend_low_i16x8_s as usize),
            I32X4_EXTEND_HIGH_I16X8_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_extend_high_i16x8_s as usize),
            I32X4_EXTEND_LOW_I16X8_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_extend_low_i16x8_u as usize),
            I32X4_EXTEND_HIGH_I16X8_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_extend_high_i16x8_u as usize),
            I64X2_EXTEND_LOW_I32X4_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i64x2_extend_low_i32x4_s as usize),
            I64X2_EXTEND_HIGH_I32X4_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i64x2_extend_high_i32x4_s as usize),
            I64X2_EXTEND_LOW_I32X4_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i64x2_extend_low_i32x4_u as usize),
            I64X2_EXTEND_HIGH_I32X4_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i64x2_extend_high_i32x4_u as usize),
            
            I16X8_EXTMUL_LOW_I8X16_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_extmul_low_i8x16_s as usize),
            I16X8_EXTMUL_HIGH_I8X16_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_extmul_high_i8x16_s as usize),
            I16X8_EXTMUL_LOW_I8X16_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_extmul_low_i8x16_u as usize),
            I16X8_EXTMUL_HIGH_I8X16_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_extmul_high_i8x16_u as usize),
            I32X4_EXTMUL_LOW_I16X8_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_extmul_low_i16x8_s as usize),
            I32X4_EXTMUL_HIGH_I16X8_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_extmul_high_i16x8_s as usize),
            I32X4_EXTMUL_LOW_I16X8_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_extmul_low_i16x8_u as usize),
            I32X4_EXTMUL_HIGH_I16X8_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_extmul_high_i16x8_u as usize),
            I64X2_EXTMUL_LOW_I32X4_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_extmul_low_i32x4_s as usize),
            I64X2_EXTMUL_HIGH_I32X4_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_extmul_high_i32x4_s as usize),
            I64X2_EXTMUL_LOW_I32X4_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_extmul_low_i32x4_u as usize),
            I64X2_EXTMUL_HIGH_I32X4_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_extmul_high_i32x4_u as usize),
            
            I16X8_EXTADD_PAIRWISE_I8X16_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_extadd_pairwise_i8x16_s as usize),
            I16X8_EXTADD_PAIRWISE_I8X16_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_extadd_pairwise_i8x16_u as usize),
            I32X4_EXTADD_PAIRWISE_I16X8_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_extadd_pairwise_i16x8_s as usize),
            I32X4_EXTADD_PAIRWISE_I16X8_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_extadd_pairwise_i16x8_u as usize),
            
            I32X4_DOT_I16X8_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_dot_i16x8_s as usize),
            I16X8_Q15MULRSAT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_q15mulrsat_s as usize),
            
            I32X4_TRUNC_SAT_F32X4_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_trunc_sat_f32x4_s as usize),
            I32X4_TRUNC_SAT_F32X4_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_trunc_sat_f32x4_u as usize),
            F32X4_CONVERT_I32X4_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_convert_i32x4_s as usize),
            F32X4_CONVERT_I32X4_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_convert_i32x4_u as usize),
            I32X4_TRUNC_SAT_F64X2_S_ZERO => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_trunc_sat_f64x2_s_zero as usize),
            I32X4_TRUNC_SAT_F64X2_U_ZERO => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_trunc_sat_f64x2_u_zero as usize),
            F64X2_CONVERT_LOW_I32X4_S => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_convert_low_i32x4_s as usize),
            F64X2_CONVERT_LOW_I32X4_U => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_convert_low_i32x4_u as usize),

            I8X16_ABS => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i8x16_abs as usize),
            I8X16_NEG => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i8x16_neg as usize),
            I8X16_POPCNT => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i8x16_popcnt as usize),
            I16X8_ABS => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_abs as usize),
            I16X8_NEG => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i16x8_neg as usize),
            I16X8_MUL => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_mul as usize),
            I32X4_ABS => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_abs as usize),
            I32X4_NEG => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i32x4_neg as usize),
            I32X4_MUL => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_mul as usize),
            I64X2_ABS => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i64x2_abs as usize),
            I64X2_NEG => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_i64x2_neg as usize),
            I64X2_MUL => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_mul as usize),
            F32X4_ABS => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_abs as usize),
            F32X4_NEG => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_neg as usize),
            F32X4_SQRT => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_sqrt as usize),
            F32X4_ADD => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_add as usize),
            F32X4_SUB => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_sub as usize),
            F32X4_MUL => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_mul as usize),
            F32X4_DIV => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_div as usize),
            F32X4_MIN => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_min as usize),
            F32X4_MAX => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_max as usize),
            F32X4_PMIN => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_pmin as usize),
            F32X4_PMAX => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_pmax as usize),

            I8X16_EQ => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_eq as usize),
            I8X16_NE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_ne as usize),
            I8X16_LT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_lt_s as usize),
            I8X16_LT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_lt_u as usize),
            I8X16_GT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_gt_s as usize),
            I8X16_GT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_gt_u as usize),
            I8X16_LE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_le_s as usize),
            I8X16_LE_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_le_u as usize),
            I8X16_GE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_ge_s as usize),
            I8X16_GE_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_ge_u as usize),

            I16X8_EQ => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_eq as usize),
            I16X8_NE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_ne as usize),
            I16X8_LT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_lt_s as usize),
            I16X8_LT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_lt_u as usize),
            I16X8_GT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_gt_s as usize),
            I16X8_GT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_gt_u as usize),
            I16X8_LE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_le_s as usize),
            I16X8_LE_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_le_u as usize),
            I16X8_GE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_ge_s as usize),
            I16X8_GE_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_ge_u as usize),

            I32X4_EQ => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_eq as usize),
            I32X4_NE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_ne as usize),
            I32X4_LT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_lt_s as usize),
            I32X4_LT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_lt_u as usize),
            I32X4_GT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_gt_s as usize),
            I32X4_GT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_gt_u as usize),
            I32X4_LE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_le_s as usize),
            I32X4_LE_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_le_u as usize),
            I32X4_GE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_ge_s as usize),
            I32X4_GE_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_ge_u as usize),

            I64X2_EQ => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_eq as usize),
            I64X2_NE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_ne as usize),
            I64X2_LT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_lt_s as usize),
            I64X2_GT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_gt_s as usize),
            I64X2_LE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_le_s as usize),
            I64X2_GE_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i64x2_ge_s as usize),

            F32X4_EQ => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_eq as usize),
            F32X4_NE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_ne as usize),
            F32X4_LT => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_lt as usize),
            F32X4_GT => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_gt as usize),
            F32X4_LE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_le as usize),
            F32X4_GE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f32x4_ge as usize),

            F64X2_EQ => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_eq as usize),
            F64X2_NE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_ne as usize),
            F64X2_LT => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_lt as usize),
            F64X2_GT => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_gt as usize),
            F64X2_LE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_le as usize),
            F64X2_GE => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_ge as usize),

            F32X4_CEIL => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_ceil as usize),
            F32X4_FLOOR => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_floor as usize),
            F32X4_TRUNC => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_trunc as usize),
            F32X4_NEAREST => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f32x4_nearest as usize),
            F64X2_ABS => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_abs as usize),
            F64X2_NEG => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_neg as usize),
            F64X2_SQRT => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_sqrt as usize),
            F64X2_ADD => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_add as usize),
            F64X2_SUB => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_sub as usize),
            F64X2_MUL => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_mul as usize),
            F64X2_DIV => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_div as usize),
            F64X2_MIN => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_min as usize),
            F64X2_MAX => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_max as usize),
            F64X2_PMIN => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_pmin as usize),
            F64X2_PMAX => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_f64x2_pmax as usize),
            F64X2_CEIL => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_ceil as usize),
            F64X2_FLOOR => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_floor as usize),
            F64X2_TRUNC => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_trunc as usize),
            F64X2_NEAREST => self.emit_simd_trampoline_unop(crate::wasm::aot::trampoline::aot_f64x2_nearest as usize),
            I8X16_MIN_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_min_s as usize),
            I8X16_MIN_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_min_u as usize),
            I8X16_MAX_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_max_s as usize),
            I8X16_MAX_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_max_u as usize),
            I8X16_AVGR_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_avgr_u as usize),
            I16X8_MIN_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_min_s as usize),
            I16X8_MIN_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_min_u as usize),
            I16X8_MAX_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_max_s as usize),
            I16X8_MAX_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_max_u as usize),
            I16X8_AVGR_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_avgr_u as usize),
            I32X4_MIN_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_min_s as usize),
            I32X4_MIN_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_min_u as usize),
            I32X4_MAX_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_max_s as usize),
            I32X4_MAX_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i32x4_max_u as usize),
            I8X16_ADD_SAT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_add_sat_s as usize),
            I8X16_ADD_SAT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_add_sat_u as usize),
            I8X16_SUB_SAT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_sub_sat_s as usize),
            I8X16_SUB_SAT_U => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i8x16_sub_sat_u as usize),
            I16X8_ADD_SAT_S => self.emit_simd_trampoline_binop(crate::wasm::aot::trampoline::aot_i16x8_add_sat_s as usize),
    ...
    fn compile_fc(&mut self, sub: u32, reader: &mut WasmReader) {
        match sub {
            0x00 => self.emit_trampoline_unop_f32_to_i32(crate::wasm::aot::trampoline::aot_i32_trunc_sat_f32_s as usize),
            0x01 => self.emit_trampoline_unop_f32_to_i32(crate::wasm::aot::trampoline::aot_i32_trunc_sat_f32_u as usize),
            0x02 => self.emit_trampoline_unop_f64_to_i32(crate::wasm::aot::trampoline::aot_i32_trunc_sat_f64_s as usize),
            0x03 => self.emit_trampoline_unop_f64_to_i32(crate::wasm::aot::trampoline::aot_i32_trunc_sat_f64_u as usize),
            0x04 => self.emit_trampoline_unop_f32_to_i64(crate::wasm::aot::trampoline::aot_i64_trunc_sat_f32_s as usize),
            0x05 => self.emit_trampoline_unop_f32_to_i64(crate::wasm::aot::trampoline::aot_i64_trunc_sat_f32_u as usize),
            0x06 => self.emit_trampoline_unop_f64_to_i64(crate::wasm::aot::trampoline::aot_i64_trunc_sat_f64_s as usize),
            0x07 => self.emit_trampoline_unop_f64_to_i64(crate::wasm::aot::trampoline::aot_i64_trunc_sat_f64_u as usize),
            0x08 => {
            ...
            0x0A => {
                reader.read_u8().unwrap(); reader.read_u8().unwrap();
                self.emitter.pop_wasm_stack(Reg::RCX);
                self.emitter.pop_wasm_stack(Reg::RDX);
                self.emitter.pop_wasm_stack(Reg::RSI);
                self.emitter.push_reg(Reg::RDI);
    ...
    fn emit_simd_splat(&mut self, lane_width: u8) {
        ...
        match lane_width {
            1 => {
                ...
                self.emitter.emit_u8(0x66); self.emitter.emit_u8(0x0F); self.emitter.emit_u8(0x70); 
                self.emitter.modrm(3, 0, 0); self.emitter.emit_u8(0);
            },
            2 => {
                self.emitter.punpcklwd_xmm_xmm(XmmReg::XMM0, XmmReg::XMM0);
                self.emitter.emit_u8(0x66); self.emitter.emit_u8(0x0F); self.emitter.emit_u8(0x70); 
    ...
    fn emit_simd_load_splat(&mut self, reader: &mut WasmReader, size: u32) {
        ...
        self.emitter.add_reg_reg(Reg::RCX, Reg::RAX);
        match size {
            1 => self.emitter.movzx_reg_mem8(Reg::RAX, Reg::RCX, memarg.offset as i32),
            2 => self.emitter.movzx_reg_mem16(Reg::RAX, Reg::RCX, memarg.offset as i32),
            4 => { self.emitter.emit_u8(0x8B); self.emitter.emit_modrm_mem(Reg::RAX, Reg::RCX, memarg.offset as i32); },
            8 => { self.emitter.mov_reg_mem64(Reg::RAX, Reg::RCX, memarg.offset as i32); },
            _ => {}
        }
        if size == 8 {
            self.emitter.movd_xmm_reg(XmmReg::XMM0, Reg::RAX);
    ...
    fn emit_simd_load_zero(&mut self, reader: &mut WasmReader, size: u32) {
        ...
        if size == 4 {
            self.emitter.emit_u8(0x66); self.emitter.emit_u8(0x0F); self.emitter.emit_u8(0x6E); 
            self.emitter.emit_modrm_mem(Reg::RAX, Reg::RCX, memarg.offset as i32);
        } else {
            self.emitter.emit_u8(0xF3); self.emitter.emit_u8(0x0F); self.emitter.emit_u8(0x7E); 
            self.emitter.emit_modrm_mem(Reg::RAX, Reg::RCX, memarg.offset as i32);
        }
        self.emitter.push_v128(XmmReg::XMM0);
    }
    ...
    fn emit_simd_extract_lane(&mut self, reader: &mut WasmReader, lane_width: u8, signed: bool) {
        ...
        match lane_width {
            1 => {
                self.emitter.pextrd_reg_xmm_imm8(Reg::RAX, XmmReg::XMM0, lane / 4);
                let shift = (lane % 4) * 8;
                if shift > 0 { self.emitter.shr_reg32_imm32(Reg::RAX, shift as u32); }
                if signed { self.emitter.movsx_reg_reg8(Reg::RAX, Reg::RAX); }
                else { self.emitter.movzx_reg_reg8(Reg::RAX, Reg::RAX); }
            },
            2 => {
                self.emitter.pextrw_reg_xmm_imm8(Reg::RAX, XmmReg::XMM0, lane);
                if signed { self.emitter.movsx_reg_reg16(Reg::RAX, Reg::RAX); }
                else { self.emitter.movzx_reg_reg16(Reg::RAX, Reg::RAX); }
            },
            4 => self.emitter.pextrd_reg_xmm_imm8(Reg::RAX, XmmReg::XMM0, lane),
            8 => self.emitter.pextrq_reg_xmm_imm8(Reg::RAX, XmmReg::XMM0, lane),
            _ => {}
        }
        self.emitter.push_wasm_stack(Reg::RAX);
    }
    ...
    fn emit_simd_replace_lane(&mut self, reader: &mut WasmReader, lane_width: u8) {
        ...
        self.emitter.pop_v128(XmmReg::XMM0);
        match lane_width {
            1 => self.emitter.pinsrb_xmm_reg_imm8(XmmReg::XMM0, Reg::RAX, lane),
            2 => self.emitter.pinsrw_xmm_reg_imm8(XmmReg::XMM0, Reg::RAX, lane),
            4 => self.emitter.pinsrd_xmm_reg_imm8(XmmReg::XMM0, Reg::RAX, lane),
            8 => self.emitter.pinsrq_xmm_reg_imm8(XmmReg::XMM0, Reg::RAX, lane),
            _ => {}
        }
        self.emitter.push_v128(XmmReg::XMM0);
        self.stack_depth -= 1;
    ...
    fn emit_atomic_load(&mut self, sub: u32, memarg: MemArg) {
        self.emitter.pop_wasm_stack(Reg::RAX);
        let size = match sub {
            0x10 => 4, 0x11 => 8, 0x12 => 1, 0x13 => 2, 0x14 => 1, 0x15 => 2, 0x16 => 4, _ => 4,
        };
        self.emit_bounds_check(Reg::RAX, size, memarg.offset);
        self.emitter.mov_reg_reg(Reg::RCX, Reg::R14);
        self.emitter.add_reg_reg(Reg::RCX, Reg::RAX);
        match sub {
            0x10 => { self.emitter.emit_u8(0x8B); self.emitter.emit_modrm_mem(Reg::RAX, Reg::RCX, memarg.offset as i32); },
            0x11 => { self.emitter.rex(true, Reg::RAX as u8, 0, Reg::RCX as u8); self.emitter.emit_u8(0x8B); self.emitter.emit_modrm_mem(Reg::RAX, Reg::RCX, memarg.offset as i32); },
            0x12 | 0x14 => self.emitter.movzx_reg_mem8(Reg::RAX, Reg::RCX, memarg.offset as i32),
            0x13 | 0x15 => self.emitter.movzx_reg_mem16(Reg::RAX, Reg::RCX, memarg.offset as i32),
            0x16 => { self.emitter.emit_u8(0x8B); self.emitter.emit_modrm_mem(Reg::RAX, Reg::RCX, memarg.offset as i32); },
            _ => {},
        }
        self.emitter.push_wasm_stack(Reg::RAX);
    }
    ...
    fn emit_atomic_store(&mut self, sub: u32, memarg: MemArg) {
        ...
        self.emitter.pop_wasm_stack(Reg::RAX);
        let size = match sub {
            0x17 => 4, 0x18 => 8, 0x19 => 1, 0x1a => 2, 0x1b => 1, 0x1c => 2, 0x1d => 4, _ => 4
        };
        self.emit_bounds_check(Reg::RAX, size, memarg.offset);
        self.emitter.mov_reg_reg(Reg::RCX, Reg::R14);
        self.emitter.add_reg_reg(Reg::RCX, Reg::RAX);
        match sub {
            0x17 => { self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RCX, memarg.offset as i32); },
            0x18 => { self.emitter.rex(true, Reg::RBX as u8, 0, Reg::RCX as u8); self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RCX, memarg.offset as i32); },
            0x19 | 0x1b => { self.emitter.emit_u8(0x86); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RCX, memarg.offset as i32); },
            0x1a | 0x1c => { self.emitter.emit_u8(0x66); self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RCX, memarg.offset as i32); },
            0x1d => { self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RCX, memarg.offset as i32); },
            _ => {}
        }
        self.stack_depth -= 2;
    }
    ...
    fn emit_atomic_rmw(&mut self, sub: u32, memarg: MemArg) {
        ...
        let size = match sub {
            0x1e | 0x1f | 0x25 | 0x26 | 0x2c | 0x2d | 0x33 | 0x34 | 0x3a | 0x3b | 0x41 | 0x42 | 0x48 | 0x49 => if sub == 0x1f || sub == 0x26 || sub == 0x2d || sub == 0x34 || sub == 0x3b || sub == 0x42 || sub == 0x49 { 8 } else { 4 },
            0x20 | 0x22 | 0x27 | 0x29 | 0x2e | 0x30 | 0x35 | 0x37 | 0x3c | 0x3e | 0x43 | 0x45 | 0x4a | 0x4c => 1,
            0x21 | 0x23 | 0x28 | 0x2a | 0x2f | 0x31 | 0x36 | 0x38 | 0x3d | 0x3f | 0x44 | 0x46 | 0x4b | 0x4d => 2,
        ...
        if is_cmpxchg {
            ...
            match size {
                1 => self.emitter.cmpxchg_mem_reg8(Reg::RCX, memarg.offset as i32, Reg::RBX),
                2 => self.emitter.cmpxchg_mem_reg16(Reg::RCX, memarg.offset as i32, Reg::RBX),
                4 => self.emitter.cmpxchg_mem_reg(Reg::RCX, memarg.offset as i32, Reg::RBX, false),
                8 => self.emitter.cmpxchg_mem_reg(Reg::RCX, memarg.offset as i32, Reg::RBX, true),
                _ => {}
            }
            self.emitter.push_wasm_stack(Reg::RAX);
            self.stack_depth -= 2;
            ...
            match sub {
                0x1e..=0x24 => { // Add
                    match size {
                        1 => self.emitter.xadd_mem_reg8(Reg::RAX, memarg.offset as i32, Reg::RBX),
                        2 => self.emitter.xadd_mem_reg16(Reg::RAX, memarg.offset as i32, Reg::RBX),
                        4 => self.emitter.xadd_mem_reg(Reg::RAX, memarg.offset as i32, Reg::RBX, false),
                        8 => self.emitter.xadd_mem_reg(Reg::RAX, memarg.offset as i32, Reg::RBX, true),
                        _ => {}
                    }
                ...
                0x25..=0x2b => { // Sub
                    match size {
                        1 => { self.emitter.emit_u8(0xF6); self.emitter.modrm(3, 3, Reg::RBX as u8); },
                        2 => { self.emitter.emit_u8(0x66); self.emitter.emit_u8(0xF7); self.emitter.modrm(3, 3, Reg::RBX as u8); },
                        4 => { self.emitter.emit_u8(0xF7); self.emitter.modrm(3, 3, Reg::RBX as u8); },
                        8 => { self.emitter.rex(true, 0, 0, Reg::RBX as u8); self.emitter.emit_u8(0xF7); self.emitter.modrm(3, 3, Reg::RBX as u8); },
                        _ => {}
                    }
                    match size {
                        1 => self.emitter.xadd_mem_reg8(Reg::RAX, memarg.offset as i32, Reg::RBX),
                ...
                0x2c..=0x40 => { // And, Or, Xor
                    let loop_label = self.emitter.new_label();
                    self.emitter.mov_reg_reg(Reg::RSI, Reg::RAX);
                    match size {
                        1 => self.emitter.movzx_reg_mem8(Reg::RAX, Reg::RSI, memarg.offset as i32),
                        2 => self.emitter.movzx_reg_mem16(Reg::RAX, Reg::RSI, memarg.offset as i32),
                        4 => { self.emitter.emit_u8(0x8B); self.emitter.emit_modrm_mem(Reg::RAX, Reg::RSI, memarg.offset as i32); },
                        8 => { self.emitter.mov_reg_mem64(Reg::RAX, Reg::RSI, memarg.offset as i32); },
                        _ => {}
                    }
                    ...
                    if sub >= 0x2c && sub <= 0x32 {
                        if is_64 { self.emitter.and_reg_reg(Reg::RCX, Reg::RBX); } else { self.emitter.and_reg32_reg32(Reg::RCX, Reg::RBX); }
                    } else if sub >= 0x33 && sub <= 0x39 {
                        if is_64 { self.emitter.or_reg_reg(Reg::RCX, Reg::RBX); } else { self.emitter.or_reg32_reg32(Reg::RCX, Reg::RBX); }
                    } else {
                        if is_64 { self.emitter.xor_reg_reg(Reg::RCX, Reg::RBX); } else { self.emitter.xor_reg32_reg32(Reg::RCX, Reg::RBX); }
                    }
                    
                    match size {
                        1 => self.emitter.cmpxchg_mem_reg8(Reg::RSI, memarg.offset as i32, Reg::RCX),
                        2 => self.emitter.cmpxchg_mem_reg16(Reg::RSI, memarg.offset as i32, Reg::RCX),
                        4 => self.emitter.cmpxchg_mem_reg(Reg::RSI, memarg.offset as i32, Reg::RCX, false),
                        8 => self.emitter.cmpxchg_mem_reg(Reg::RSI, memarg.offset as i32, Reg::RCX, true),
                        _ => {}
                    }
                ...
                0x41..=0x47 => { // Xchg
                     match size {
                        1 => { self.emitter.emit_u8(0x86); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RAX, memarg.offset as i32); },
                        2 => { self.emitter.emit_u8(0x66); self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RAX, memarg.offset as i32); },
                        4 => { self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RAX, memarg.offset as i32); },
                        8 => { self.emitter.rex(true, Reg::RBX as u8, 0, Reg::RAX as u8); self.emitter.emit_u8(0x87); self.emitter.emit_modrm_mem(Reg::RBX, Reg::RAX, memarg.offset as i32); },
                        _ => {}
                    }
                    self.emitter.mov_mem64_reg(Reg::RSP, 0, Reg::RBX);
                },
