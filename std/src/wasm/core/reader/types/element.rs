...
use super::RefType;
use crate::wasm::core::indices::{FuncIdx, TableIdx};
use crate::wasm::core::reader::span::Span;
use crate::wasm::core::reader::types::TableType;
...
use crate::wasm::{ValType, ValidationError};
...
fn parse_validate_active_segment_offset_expr(
    ...
    valid_stack.assert_val_types(&[ValType::NumType(crate::wasm::NumType::I32)], true)?;
    Ok(span)
}
