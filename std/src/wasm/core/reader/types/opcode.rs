...
pub const GC_PREFIX: u8 = 0xFB; // Standard GC
pub const GC_PREFIX_ALT: u8 = 0xFF; // Requested user prefix
...
pub fn fc_extension_opcode_to_str(instr: u32) -> crate::rust_alloc::borrow::Cow<'static, str> {
    match instr {
        ...
        0x10 => "TABLE_SIZE",
        0x11 => "TABLE_FILL",
        instr => return crate::rust_alloc::format!("UNKNOWN({instr:x})").into(),
    }
        .into()
}
...
#[cfg(debug_assertions)]
pub fn fd_extension_opcode_to_str(instr: u32) -> crate::rust_alloc::borrow::Cow<'static, str> {
    use fd_extensions::*;
    match instr {
        V128_LOAD => "V128_LOAD",
...
#[cfg(debug_assertions)]
pub fn opcode_byte_to_str(byte: u8) -> crate::rust_alloc::borrow::Cow<'static, str> {
    match byte {
