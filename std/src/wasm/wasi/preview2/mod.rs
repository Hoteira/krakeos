...
pub fn create_wasi_p2_imports<T: Config + Clone + Send + 'static>(linker: &mut Linker, store: &mut Store<'_, T>) {
    ...
    // krakeos:system/window@0.2.0
    {
        ...
        // wasi:filesystem/types@0.2.0
        {
            ...
            define(linker, store, module, "[method]directory-entry-stream.read-directory-entry", vec![ValType::NumType(NumType::I32), ValType::NumType(NumType::I32)], vec![], crate::fs::wasi::directory_entry_stream_read_directory_entry);
