...
macro_rules! export_method {
    ...
    (
        ...
        [$($compat:expr),*], 
        $params:expr, $returns:expr,
        $vis:vis fn $func_name:ident <$t:ident: Config + Clone>($store:tt: &mut Store<'_, $t_ignore:ident>, $args:tt: Vec<Value>) -> Result<Vec<Value>, HaltExecutionError> $body:block
    ) => {
        $vis fn $func_name<$t: Config + Clone>($store: &mut Store<'_, $t>, $args: Vec<Value>) -> Result<Vec<Value>, HaltExecutionError> $body

        #[allow(non_snake_case)]
        pub mod $func_name {
            use super::*;
            pub fn register<$t: Config + Clone>(linker: &mut $crate::wasm::Linker, store: &mut $crate::wasm::Store<'_, $t>) {
                let func_type = $crate::wasm::common::reader::types::FuncType {
                    params: $crate::wasm::common::reader::types::ResultType { valtypes: $params },
                    returns: $crate::wasm::common::reader::types::ResultType { valtypes: $returns },
                };
    ...
    (
        ...
        [$($compat:expr),*], 
        $params:expr, $returns:expr,
        $vis:vis fn $func_name:ident <$t:ident: Config + Clone + Send + 'static>($store:tt: &mut Store<'_, $t_ignore:ident>, $args:tt: Vec<Value>) -> Result<Vec<Value>, HaltExecutionError> $body:block
    ) => {
        $vis fn $func_name<$t: Config + Clone + Send + 'static>($store: &mut Store<'_, $t>, $args: Vec<Value>) -> Result<Vec<Value>, HaltExecutionError> $body

        #[allow(non_snake_case)]
        pub mod $func_name {
            use super::*;
            pub fn register<$t: Config + Clone + Send + 'static>(linker: &mut $crate::wasm::Linker, store: &mut $crate::wasm::Store<'_, $t>) {
                let func_type = $crate::wasm::common::reader::types::FuncType {
                    params: $crate::wasm::common::reader::types::ResultType { valtypes: $params },
                    returns: $crate::wasm::common::reader::types::ResultType { valtypes: $returns },
                };
