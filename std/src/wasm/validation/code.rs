...
use crate::wasm::core::reader::types::element::ElemType;
use crate::wasm::core::reader::types::global::Global;
use crate::wasm::core::reader::types::memarg::MemArg;
use crate::wasm::core::reader::types::{BlockType, FuncType, MemType, NumType, TableType, ValType};
use crate::wasm::core::reader::{WasmReadable, WasmReader};
use crate::wasm::core::sidetable::{Sidetable, SidetableEntry};
use crate::wasm::validation::validation_stack::{LabelInfo, ValidationStack};
...
fn read_instructions(
    ...
    loop {
        ...
        crate::wasm::core::utils::print_beautiful_instruction_name_1_byte(first_instr_byte, wasm.pc);
                    ...
                    LabelInfo::Func { stps_to_backpatch } => {
                        stps_to_backpatch.iter().for_each(|i| {
                            sidetable[*i].delta_pc =
                                (wasm.pc as isize) - sidetable[*i].delta_pc - 1;
                            sidetable[*i].delta_stp = (stp_here as isize) - sidetable[*i].delta_stp;
                        });
                    }
