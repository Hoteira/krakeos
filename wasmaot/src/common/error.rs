...
use crate::common::indices::GlobalIdx;
use crate::common::reader::section_header::SectionTy;
use crate::common::reader::types::ValType;
use crate::common::validation::validation_stack::ValidationStackEntry;
...
impl Display for ValidationError {
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        match self {
            ValidationError::Component(e) => write!(f, "Component (unsupported), tag {:#x}", e),
            ...
            ValidationError::MalformedDataSegmentMode(mode) => write!(f, "Failed to parse {mode} as a data segment mode"),
