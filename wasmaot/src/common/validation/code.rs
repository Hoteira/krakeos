...
use crate::common::reader::types::element::ElemType;
use crate::common::reader::types::global::Global;
use crate::common::reader::types::memarg::MemArg;
use crate::common::reader::types::{BlockType, FuncType, MemType, NumType, TableType, ValType, RefType};
use crate::common::reader::{WasmReadable, WasmReader};
use crate::common::sidetable::{Sidetable, SidetableEntry};
use crate::common::validation::validation_stack::{LabelInfo, ValidationStack};
use core::iter;
    ...
    loop {
        ...
        match first_instr_byte {
            ...
            FC_EXTENSIONS => {
                ...
                use crate::common::reader::types::opcode::fc_extensions::*;
                match second {
            ...
            FD_EXTENSIONS => {
                let second = wasm.read_var_u32()?;
                use crate::common::reader::types::opcode::fd_extensions::*;
                match second {
